/** Locale dictionaries for the appearance settings tab. */
...
export type AppearanceKey =
  ...
  | 'previewingBar'
  | 'themeOnly'
  | 'customCss' | 'customCssHint' | 'customVars' | 'customVarsHint'

export const appearanceZh: Record<AppearanceKey, string> = {
  nav: '外观',
  title: '外观',
  ...
  themeOnly: '请只开一套主题',
  customCss: '自定义 CSS',
  customCssHint: '写入页面的附加样式。会过滤危险片段，最长 32KB。',
  customVars: '自定义变量',
  customVarsHint: '每行一条 `--name: value`，写入 html。',
}

export const appearanceEn: Record<AppearanceKey, string> = {
  nav: 'Appearance',
  title: 'Appearance',
  ...
  themeOnly: 'Please enable only one theme',
  customCss: 'Custom CSS',
  customCssHint: 'Extra stylesheet written into the page. Dangerous fragments are stripped; max 32KB.',
  customVars: 'Custom variables',
  customVarsHint: 'One `--name: value` per line, written onto html.',
}
